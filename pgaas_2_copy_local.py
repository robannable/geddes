...
class ResponseProcessor:
    ...
    def process_llm_response(response_json, user_name, prompt, unique_files, chunk_info):
        ...
        st.session_state.current_metrics = {
            ...
            'temperature': {
                0.7: evaluation_results.get('temperature_effectiveness', {}).get(0.7, 0),
                0.8: evaluation_results.get('temperature_effectiveness', {}).get(0.8, 0),
                0.9: evaluation_results.get('temperature_effectiveness', {}).get(0.9, 0)
            }
        }
...
class ResponseEvaluator:
    ...
    def evaluate_response(self, response, mode, temperature):
        ...
        evaluation = {
            ...
            'temperature_effectiveness': temperature
        }
        
        logger.info(f"Response evaluation: {evaluation}")
        return evaluation

# Initialize session state objects and preload model
